...
import com.helloWorldTech.funQuest.data.remote.interceptor.HeaderInterceptor;
import com.helloWorldTech.funQuest.data.remote.interceptor.RequestInterceptor;
import com.helloWorldTech.funQuest.util.LiveDataCallAdapterFactory;
...
public class ApiModule {
    ...
    OkHttpClient provideOkhttpClient(Cache cache , Application application) {
        ...
        httpClient.addInterceptor(new ChuckInterceptor(application));
